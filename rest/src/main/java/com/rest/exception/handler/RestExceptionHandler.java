 ...
 */
package com.rest.exception.handler;
...
import com.rest.exception.convert.MapRestErrorConverter;
import com.rest.exception.convert.RestErrorConverter;
import com.rest.exception.model.RestError;
import com.rest.exception.resolver.DefaultRestErrorResolver;
import com.rest.exception.resolver.RestErrorResolver;
 ...
 *     {@link com.surdoc.web.httprest.exception.handler.stormpath.spring.web.servlet.handler.RestError#getStatus() status} value.</li>
...
public class RestExceptionHandler extends AbstractHandlerExceptionResolver implements InitializingBean {
    ...
    private RestErrorConverter<Map<String, Object>> errorConverter;
    ...
    public RestErrorConverter<Map<String, Object>> getErrorConverter() {
        return errorConverter;
    }

    public void setErrorConverter(RestErrorConverter<Map<String, Object>> errorConverter) {
    ...
    protected ModelAndView getModelAndView(ServletWebRequest webRequest, Object handler, RestError error) throws Exception {
        ...
        RestErrorConverter<Map<String, Object>> converter = getErrorConverter();
        if (converter != null) {
